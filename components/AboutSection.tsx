      ...
      <div className="my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <br />
            <p>
              I am currently studying at Peter the Great St. Petersburg 
              Polytechnic University, majoring in Computer Security. 
              The training ends in February 2024
            </p>
            <br />
            <p>
              I have a lot of hobbies that allow me not to get bored: from reading 
              and visiting high art exhibitions to photographing and sports
